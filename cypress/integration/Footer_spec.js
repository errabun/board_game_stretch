describe('App', () => {
  ...
  it('Should have a link to Eric\'s Github page', () => {
    ...
    cy.get('a').should('contain', 'Eric Rabun')
  })

  it('Should have a link to Ryan\'s Github page', () => {

    cy.get('a').should('contain', 'Ryan Miller')
  })

  it('Should have a link to Melanie\'s Github page', () => {

    cy.get('a').should('contain', 'Melanie Daoheuang')
  })
})
